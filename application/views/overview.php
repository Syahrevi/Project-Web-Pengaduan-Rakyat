...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php base_url('https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css')?>" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
        <link href="<?php base_url('https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css')?>" rel="stylesheet" crossorigin="anonymous" />
        <script src="<?php base_url('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.0/js/all.min.js')?>" crossorigin="anonymous"></script>
    </head>
    <body class="sb-nav-fixed">
        ...
        <script src="<?php echo('https://code.jquery.com/jquery-3.5.1.min.js')?>" crossorigin="anonymous"></script>
        <script src="<?php echo('https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.bundle.min.js" crossorigin="anonymous')?>"></script>
